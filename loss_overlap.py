...
def loss_overlap(s_u, s_a, bw_u=None, bw_a=None, x_num=1000,
    ...
    xmin -= dx
    xmax += dx
    x = torch.linspace(xmin.detach(), xmax.detach(), x_num).to(device)  # linspace生成一个一维的等差数列
